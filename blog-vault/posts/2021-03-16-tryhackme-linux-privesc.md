...
![banner-image|640](thm-linux-privesc-banner.png)
...
![SSH Login|520](posts/images/thm-linux-privesc/ssh-login.png)
...
![Compiling Binary Files for MySQL](mysql-binary-file.png)
...
![Listing content of Shadow File](shadow-file-content.png)
...
![Password File Permissions|400](password-file.png)
...
![Saving Hash directly in the Password File|400](write-hash-to-password-file.png)

Now let's see if we can log in as the user "newroot" which should have the same permissions as the root user.

![Login as Root User|240](root-login.png)
...
![Listing Sudoers File|450](posts/images/thm-linux-privesc/sudoers-file-content.png)
...
![Finding sudo Exploit](posts/images/thm-linux-privesc/sudo-exploit.png)
...
![Login as Root User|300](root-login-2.png)
...
![Sudoers File Content|450](sudoers-file-content-2.png)
...
![C Shared Object Code|400](c-exploit-code.png)
...
![Compiling Exploit Code](compiling-exploit-code.png)
...
![Changing Path Variable](changing-env.png)
...
![Same exploit using different Binary File](exploit-different-binary.png)
...
![Listing Cron Jobs](cron-jobs.png)
...
![Adding Listener on Script|400](listener-on-cron-script.png)
...
![Listing Cron Jobs](cron-jobs-2.png)
...
![List file Content|380](file-content.png)
...
![Create Msfvenom Payload](posts/images/thm-linux-privesc/msfvenom-payload.png)
...
![Downloading Payload on Target](download-payload.png)
...
![Reverse Shell|420](reverse-shell.png)
...
![Finding files by their Permissions](find-files-by-permission.png)
...
![Searching for Exploit|400](posts/images/thm-linux-privesc/finding-exploit.png)
...
![Using Exploit to Gain Access|420](using-exploit.png)
...
![Running Executable with Modified Library File](executing-with-modifed-file.png)
...
![Executing Binary File|450](executing-binary.png)
...
![Malicious Service Binary](malicious-binary-file.png)
...
![Checking Shell Version|460](shell-version.png)
...
![Exploiting Shell Path Bug|400](exploiting-shell.png)
...
![Exploiting Shell Vulnerability](exploiting-shell-2.png)
...
![View Config File Values|300](config-files.png)
...
![Viewing SSH Files|500](ssh-files.png)
...
![NFS Config File|550](nfs-config-file.png)
...
![Search for Kernal Exploits|520](search-kernal-exploits.png)
...
![Running Kernal Exploit](exeuting-kernel-exploit.png)
...
![LinPeas Files|380](linpeas-files.png)
...
![LinPeas Output 1](target-osint-1.png)

![LinPeas Output 2](posts/images/thm-linux-privesc/target-osint-2.png)

![LinPeas Output 3|520](posts/images/thm-linux-privesc/target-osint-3.png)

![LinPeas Output 4](posts/images/thm-linux-privesc/target-osint-4.png)

![LinPeas Output 5|560](posts/images/thm-linux-privesc/target-osint-5.png)

![LinPeas Output 6|400](posts/images/thm-linux-privesc/target-osint-6.png)

![LinPeas Output 7](target-osint-7.png)

![LinPeas Output 8|250](target-osint-8.png)

![LinPeas Output 9](target-osint-9.png)

![LinPeas Output 10|400](target-osint-10.png)

![LinPeas Output 11|550](target-osint-11.png)
