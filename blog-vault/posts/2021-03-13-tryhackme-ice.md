...
![banner-image|640](thm-ice-banner.png)
...
![TryHackMe VPN File|450](thm-vpn-file.png)
...
![Connected to VPN Server|450](thm-vpn-connected.png)
...
![Nmap Vulnerability Scan Results](nmap-scan-result-2.png)

> 3389

![Nmap Vulnerability Scan Results](nmap-scan-results-3.png)
...
![Search Metasploit for Exploit](metasploit-exploits.png)
...
![Exploit Settings](exploit-settings.png)
...
![Changing Exploit Parameters|450](setting-exploit-parameters.png)

> No answer required

![Running Exploit on Target](posts/images/thm-ice/running-exploit.png)
...
![Gathering Target Details|450](posts/images/thm-ice/target-osint.png)
...
![Running Exploit Suggester](running-exploit-suggester.png)
...
![Running UAC Exploit](running-uac-exploit.png)
...
![Checking Available Sessions](checking-sessions.png)
...
![Listing available Privileges|210](available-privileges.png)
...
![Target System Processes](posts/images/thm-ice/target-osint-2.png)
...
![Migrating Meterpreter|280](migrate-meterpreter.png)
...
![Launching Kiwi Tool|500](kiwi-options.png)
...
![Kiwi Commands|520](kiwi-commands.png)
...
![Target Credentials](kiwi-credentials.png)
...
![Timestomp Command|350](timestamp-command.png)
...
![Kiwi Kerberos Command|500](kiwi-commands-2.png)
...
![Enabling RDP on Target](enabling-rdp.png)
...
![Access Target System via RDP](login-target-rdp.png)
...
![Msfvenom Payload](posts/images/thm-ice/msfvenom-payload.png)
...
![Changing Options for Payload](msfvenom-payload-2.png)
...
![Netcat Listener|440](posts/images/thm-ice/netcat-listener.png)

![Access Target using Payload|380](payload-target-access.png)

As we can see we have got managed to gain access to the system.

![Listing current User|340](posts/images/thm-ice/target-osint-3.png)
...
![Exploit Suggester Database|340](exploit-suggester-db.png)

```
./windows-exploit-suggester.py --database 2021-03-12-mssb.xls --systeminfo ../systeminfo.txt > exploits.txt
```

![Running Exploit Suggester](exploit-suggester.png)
...
![Downloading File 1](downloading-file-1.png)

![Downloading File 2](downloading-file-2.png)
...
![Running Exploit|350](running-exploit-2.png)

![List Current User|480](listing-users.png)
...
![Downloading Mimikatz](downloading-mimikatz.png)
