...
![banner-image|640](python-to-exe-banner.png)
...
![auto-py-to-exe GUI|500](auto-py-to-exe.png)
...
![App Structure|180](app-structure.png)
...
![App Options|540](app-options.png)
...
![Path Changes|600](path-changes.png)

That's it. With these changes, we are now ready to generate an executable from our code.

![App Options 2|540](app-options-2.png)

![Conversion Output|500](conversion-output.png)

![Running Code|600](running-code.gif)
...
![Temp Directory|600](temp-directory.png)
