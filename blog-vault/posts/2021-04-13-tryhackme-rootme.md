...
![RustScan Results|550](posts/images/thm-rootme/rustscan-results.png)
...
![Nmap Results](posts/images/thm-rootme/nmap-results.png)
...
![Web App Landing Page](posts/images/thm-rootme/webapp-landing-page.png)

We get a webpage. Let's try to brute force the website and see if we find any hidden directories.

![Gobuster Results](posts/images/thm-rootme/gobuster-results.png)
...
![BurpSuite Intruder](posts/images/thm-rootme/burpsuite-intruder.png)
...
![BurpSuite Intruder Options](posts/images/thm-rootme/burpsuite-intruder-options.png)
...
![Burpsuite Intruder Results](posts/images/thm-rootme/burpsuite-intruder-results.png)
...
![Execute Reverse Shell|400](execute-reverse-shell.png)
...
![Setup Netcat Listener](posts/images/thm-rootme/netcat-listener.png)
...
![Searching for Flag|360](finding-flag-file.png)
...
![Finding Misconfigured Binary File](finding-misconfigured-binary.png)
...
![Binary Exploit Instructions](binary-exploit-step.png)
...
![Root Flag File](finding-flag-file-2.png)
