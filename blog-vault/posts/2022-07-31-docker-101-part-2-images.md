...
![banner-image|640](posts/images/docker-images/docker-101-banner.png)
...
![Docker Hub Overview](docker-hub-overview.png)
...
![Docker Image Pull|550](docker-image-pull.png)
...
![Docker Image Download](docker-image-download.png)
...
![List Docker Images](docker-image-list.png)
...
![Docker Image Tags](docker-image-tags.png)
...
![Docker Image Download 2|550](docker-image-download-2.png)

Now, if we list the images, we will see that two versions of Alpine are now locally available.

![Docker Image List 2|550](docker-image-list-2.png)
...
![Docker Image Layers|580](docker-image-layers.png)
...
![Docker Image Details](docker-image-details.png)
...
![Docker Image Delete](docker-image-delete.png)
...
![Docker Image Help|550](docker-image-help.png)
