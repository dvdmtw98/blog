...
![banner-image|640](building-home-lab-part-4-banner.png)
...
![pfsense-26|500](pfsense-26.png)

This will open the pfSense Web UI login page. Login using the default credentials.  
Username: **`admin`**  
Password: **`pfsense`**

![pfsense-27|600](pfsense-27.png)

Click on **`Next`**.

![pfsense-28|600](pfsense-28.png)

Click **`Next`** again.

![pfsense-29|600](pfsense-29.png)
...
![pfsense-30|600](pfsense-30.png)

Select your <u>Timezone</u> and then click **`Next`**. 

![pfsense-31|600](pfsense-31.png)
...
![pfsense-42|600](pfsense-42.png)

### DNS Resolver Configuration

From the navigation bar select **`Services -> DNS Resolver`**.

![pfsense-43|600](pfsense-43.png)
...
![pfsense-44|600](pfsense-44.png)

Click on **`Advanced Settings`**.

![pfsense-45|600](pfsense-45.png)
...
![pfsense-46|600](pfsense-46.png)

A popup will appear at the top of the page. Click on **`Apply Changes`**.

![pfsense-47|600](pfsense-47.png)
...
![pfsense-48|600](pfsense-48.png)

Go to the **`Networking`** tab

![pfsense-49|600](pfsense-49.png)
...
![pfsense-64|600](pfsense-64.png)

In the <u>IP</u> tab click on **`Add`** to create a new alias.

![pfsense-65|600](pfsense-65.png)
...
![pfsense-80|600](pfsense-80.png)

Click on the **`Apply Changes`** button in the popup at the top of the screen.

![pfsense-81|600](pfsense-81.png)

The final rules should look as follows:

![pfsense-82|600](pfsense-82.png)
...
[Part 5 - Cyber Range Setup](https://blog.davidvarghese.com/posts/building-home-lab-part-5/)
