...
![Bandit 31 Repository](clone_bandit31_repo.png)
...
![List Files in Directory|380](list_files_in_dir.png)
...
![View the content of File|450](cat_file_content.png)
...
![Writing Data to File|460](write_data_to_file.png)
...
![Removing .gitignore File|420](removing_git_ignore.png)

Now that we have deleted ".gitignore" let us commit the changes and push the changes to the remote repository.

![Committing Changes to Repository|550](committing_changes_to_repo.png)
