...
![banner-image|640](thm-vulnversity-banner.png)
...
![Nmap Scan Results](posts/images/thm-vulnversity/nmap-scan-results.png)
...
![Nmap Options|540](nmap-options.png)
...
![Site Landing Page](posts/images/thm-vulnversity/webapp-landing-page.png)
...
![Gobuster Results](posts/images/thm-vulnversity/gobuster-results.png)
...
![App Upload Page](webapp-load-page.png)
...
![Upload TXT File|350](upload-txt-file.png)
...
![Upload PHP File|350](upload-php-file.png)
...
![List of Extensions to Test|240](extensions-to-test.png)
...
![Burpsuite Intruder](posts/images/thm-vulnversity/burpsuite-intruder.png)
...
![Burpsuite Intruder Options](posts/images/thm-vulnversity/burpsuite-intruder-options.png)
...
![Burpsuite Intruder Results](posts/images/thm-vulnversity/burpsuite-intruder-results.png)
...
![PHP Exploit Settings|300](php-exploit-settings.png)

Save the script with the .phtml extension and upload the file on the Upload page.

![Upload PHTML File|350](upload-php-file-2.png)
...
![Executing Exploit|400](execute-exploit.png)

![Setting Up Reverse Shell](setup-reverse-shell.png)
...
![Username on Target System|280](target-username.png)
...
![Searching for Exploitable Files|580](finding-exploitable-files.png)
...
![GTFOBins Exploit](gtfobins-exploit.png)
...
![Finding Writable Directories|360](finding-writable-directories.png)

Let's use the "/var/tmp" directory for all the operations from here on out.

![Finding Flag on System](posts/images/thm-vulnversity/finding-flag.png)
