...
![banner-image|640](agent-sudo-banner.png)
...
![user-agent|480](user-agent.png)

![WebApp 2|520](web-app-2.png)
...
![Hydra Attack|600](hydra-attack.png)
...
![Instruction|600](instruction.png)
...
![John Cracking|550](john-cracking.png)
...
![Extract Archive|600](extract-archive.png)
...
![Instruction 2|460](instruction-2.png)
...
![SSH Login|600](posts/images/thm-agent-sudo/ssh-login.png)
...
![SSH Login 2|460](ssh-login-2.png)
...
![News Article|600](news-article.png)
...
![Sudo Version|320](sudo-version.png)
...
![Sudo Exploit|600](posts/images/thm-agent-sudo/sudo-exploit.png)
...
![Sudo Exploit 2|350](sudo-exploit-2.png)
