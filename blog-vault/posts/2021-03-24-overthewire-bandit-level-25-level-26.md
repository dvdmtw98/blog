...
![Access Target via SSH|550](posts/images/bandit-25-26/target-ssh-login.png)
...
![Target SSH Login Failed|300](target-ssh-login-2.png)
...
![Finding Target Default Shell|500](target-default-shell.png)
...
![View Shell Content|320](shell-content.png)
...
![More Command Example|500](more-example.png)
...
![Shell Output|640](shell-output.png)
...
![Opening Editor from More|640](opening-editor.png)
...
![Set Default Shell via Vim|420](default-shell-via-vim.png)
...
![Launch Shell|420](launch-shell.png)
...
![Bandit26 Password|380](bandit26-password.png)
