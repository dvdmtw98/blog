...
![banner-image|640](kioptrix-level-3-banner.png)
...
![Subnet Details|600](subnet-details.png)
...
![Netdiscover|580](posts/images/vulnhub-kioptrix-lvl3/netdiscover.png)
...
![Domain Mapping|440](domain-mapping.png)
...
![Rust Scan|520](port-scan.png)

There are two ports open: 22 and 80

![Port Scan Details|620](port-scan-2.png)
...
![Feroxbuster|600](posts/images/vulnhub-kioptrix-lvl3/feroxbuster.png)
...
![Web App|600](posts/images/vulnhub-kioptrix-lvl3/webapp.png)

The `/modules` directory contains some `.php` files but they don't look important. The `/gallery` route opens an image gallery.

![Web App 3|600](posts/images/vulnhub-kioptrix-lvl3/webapp-3.png)
...
![Webapp 6|560](posts/images/vulnhub-kioptrix-lvl3/webapp-6.png)
...
![Reverse Shell Listener|440](lotus-cms-3.png)
...
![Config File|500](lotus-cms-4.png)
...
![phpMyAdmin|560](phpmyadmin.png)

![phpMyAdmin|180](phpmyadmin-2.png)

![phpmyAdmin|600](phpmyadmin-3.png)

![phpMyAdmin|480](phpmyadmin-5.png)

The `dev_accounts` table contains the hashed passwords for user `dreg` and `loneferret`.

![phpMyAdmin|500](phpmyadmin-6.png)
...
![Hash Type|500](hash-1.png)

![Cracking Hash|600](hash-2.png)
...
![Web App 4|600](posts/images/vulnhub-kioptrix-lvl3/webapp-4.png)
...
![SQL Injection|600](sql-injection-1.png)
...
![SQL Injection|600](sql-injection-2.png)
...
![SQL Injection|600](sql-injection-3.png)
...
![SQL Injection|600](sql-injection-4.png)
...
![SQL Injection|600](sql-injection-5.png)
...
![WebApp 5|600](posts/images/vulnhub-kioptrix-lvl3/webapp-5.png)
...
![Gallery|600](gallery-10.png)

![LFI Listeer|540](lfi.png)
...
![Directory Content|600](posts/images/vulnhub-kioptrix-lvl3/ssh-2.png)
...
![Sudo Permissions|460](posts/images/vulnhub-kioptrix-lvl3/ssh-3.png)
...
![HT Editor|400](ht-1.png)

Using F3 we can select the file to open in the editor.

![HT Editor|440](ht-2.png)

![HT Editor|500](ht-3.png)
...
![Root|440](posts/images/vulnhub-kioptrix-lvl3/root-1.png)
...
Next Level: [VulnHub - Kioptrix: Level 4 (1.3) (#4)](https://blog.davidvarghese.com/posts/vulnhub-kioptrix-level-4/)
