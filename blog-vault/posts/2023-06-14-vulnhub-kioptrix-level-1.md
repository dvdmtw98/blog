...
![banner-image|640](kioptrix-level-1-banner.png)
...
![Attach Machine IP](attach-ip.png)
...
![Netdiscover Results|580](netdiscover-result.png)
...
![Rust scan Result|600](posts/images/vulnhub-kioptrix-lvl1/rustscan-result.png)
...
![Feroxbuster Scan Result](feroxbuster-scan-result.png)
...
![SSL Search Result|500](ssl-search-result.png)
...
![Samba Enumeration 1](samba-enum-1.png)
...
![Samba Enumeration 2](samba-enum-2.png)
...
![Samba Enumeration 1](samba-enumeration-1.png)

![Samba Enumeration 2](samba-enumeration-2.png)

![Samba Enumeration 3|540](samba-enumeration-3.png)

We find that the target is running `Samba 2.2.1a`.

![Samba Search Result|500](samba-search-result.png)
...
![Apache Exploit 2|450](apache-exploit-2.png)
...
![Apache Exploit 3|400](apache-exploit-3.png)
...
![Apache Exploit|500](apache-exploit.png)
...
![Samba Exploit 1|440](samba-exploit-1.png)
...
![Samba Exploit 2](samba-exploit-2.png)

![Samba Exploit 3](samba-exploit-3.png)

![Samba Exploit 4|400](samba-exploit-4.png)
...
![Samba Exploit 5](samba-exploit-5.png)
...
![Samba Exploit 6](samba-exploit-6.png)

On using the new payload we can establish a connection. On running `whoami` we can see that we have got root access.

Next Level: [VulnHub - Kioptrix: Level 2 (1.1) (#2)](https://blog.davidvarghese.com/posts/vulnhub-kioptrix-level-2/)
