...
![banner-image|640](posts/images/docker-volumes/docker-101-banner.png)
...
![Docker Container Structure|580](docker-container-structure.png)
...
![List Docker Volumes|210](docker-volume-ls-1.png)
...
![Volume Configuration|540](docker-volume-inspect.png)
...
![Starting MySQL Container|640](docker-container-run-1.png)

After starting the container let's look at the volumes present in Docker

![Listing Docker Volumes|540](docker-volume-ls-2.png)
...
![Inspect Container Configuration|640](posts/images/docker-volumes/docker-container-inspect.png)
...
![Docker Volumes|220](posts/images/docker-volumes/docker-container-run-2.png)
...
![Docker Volume List|250](docker-volume-ls-4.png)
...
![Docker Container with Volume|640](posts/images/docker-volumes/docker-container-run-3.png)
...
![Project Structure Host|290](project-structure-host.png)
...
![Docker Container Run|600](posts/images/docker-volumes/docker-container-run-4.png)
...
![Project in Docker Container|320](project-structure-container.png)
...
![Copy Data from Host|360](docker-copy.png)
