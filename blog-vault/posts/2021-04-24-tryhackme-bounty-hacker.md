...
![banner-image|640](thm-bounty-hacker-banner.png)
...
![RustScan Results|550](posts/images/thm-bounty-hacker/rustscan-results.png)
...
![Nmap Results](posts/images/thm-bounty-hacker/nmap-results.png)
...
![Nmap FTP Enumeration|550](nmap-ftp-enumeration.png)
...
![FTP Server Access|480](ftp-access.png)
...
![Files Downloaded by FTP|280](ftp-downloaded-files.png)
...
![Hydra Password Cracking](posts/images/thm-bounty-hacker/hydra-password-cracking.png)
...
![SSH Login|520](posts/images/thm-bounty-hacker/ssh-login.png)

Let us list the files that are present in the current directory and see if any flags are present.

![Flag File 1|340](posts/images/thm-bounty-hacker/flag-file-1.png)
...
![Sudoers File Content](posts/images/thm-bounty-hacker/sudoers-file-content.png)
...
![Exploit Usage Instructions](exploit-instructions.png)
...
![Flag File 2](posts/images/thm-bounty-hacker/flag-file-2.png)
