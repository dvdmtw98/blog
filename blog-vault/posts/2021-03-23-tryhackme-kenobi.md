...
![banner-image|640](thm-kenobi-banner.png)
...
![RustScan Results](posts/images/thm-kenobi/rustscan-results.png)
...
![Nmap Scan Results](posts/images/thm-kenobi/nmap-scan-results.png)
...
![SMB Shares on Target|380](smb-shares.png)
...
![Connect to Target via SMB|500](smb-connect-target.png)
...
![Download SMB Share File|450](smb-content-download.png)

Now that we have downloaded the share let's look at the "log.txt" file and see what information we can collect.

![Log File Content|460](log-file-content-1.png)

![Log File Content|300](log-file-content-2.png)

![Log File Content|520](log-file-content-3.png)
...
![Nmap NFS Enumeration|500](nmap-service-enumeration.png)
...
![Netcat into FTP Server](netcat-ftp-service.png)
...
![Search for FTP Exploit|450](search-ftp-exploit.png)
...
![Copy SSH Key|480](copy-ssh-file.png)
...
![Mount NFS Share|420](mount-nfs-share.png)
...
![Access Target via SSH|500](ssh-target.png)
...
![Finding Misconfigured Files|550](find-misconfigured-files.png)
...
![Running Binary File|280](run-binary-file.png)
...
![Checking Binary File|360](binary-file-content.png)
...
![Exploit Binary File for Root Access](exploit-binary-file.png)
