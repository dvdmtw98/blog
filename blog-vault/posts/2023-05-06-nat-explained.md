...
![banner-image|640](nat-explained-banner.png)
...
![Private IPv4 Address Space|500](private-ip-address-space.png)
...
![Public IPv4 Address Space|400](public-ip-address-space.png)
...
- [NAT (Network Address Translation) - Digital Archive](https://notes.davidvarghese.com/computer-networks/layer-wise-concepts/network-layer-concepts/network-address-translation-nat)
