...
![banner-image|640](building-home-lab-part-7-banner.png)
...
![dc-119|240](dc-119.png)

Click on **`Continue`** to restart the system.

![dc-120|300](dc-120.png)
...
![dc-112|400](dc-112.png)

Click on **`Next`**.

![dc-113|580](dc-113.png)

Enable "<u>Certification Authority</u>" and click on **`Next`**.

![dc-114|580](dc-114.png)

Click on **`Next`**.

![dc-115|580](dc-115.png)

Click on **`Next`**.

![dc-116|580](dc-116.png)

Click on **`Next`** till you reach the <u>Confirmation</u> page. Click on **`Configure`** to save the changes.

![dc-117|580](dc-117.png)

Click on **`Close`**.

![dc-118|580](dc-118.png)
...
![dc-152|600](dc-152.png)

Set the policy to **`Enabled`**. Click on **`Apply`** then **`OK`**. Close Group Policy Management Editor.

![dc-153|500](dc-153.png)
...
![user-8|540](user-8.png)

Click on **`Skip`**.

![user-9|540](user-9.png)
...
![user-26|500](user-26.png)

Click on **`Advanced system settings`**.

![user-27|540](user-27.png)

Select the "<u>Computer Name</u>" tab and click on **`Change`**.

![user-28|360](user-28.png)
...
![user-40|360](user-40.png)

![user-44|360](user-44.png)

![user-41|360](user-41.png)
...
![user-42|600](user-42.png)

![user-43|540](user-43.png)
...
[Part 7 - Malware Analysis Lab Setup](https://blog.davidvarghese.com/posts/building-home-lab-part-8)
