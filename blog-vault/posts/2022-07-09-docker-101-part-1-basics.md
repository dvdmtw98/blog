...
![banner-image|640](posts/images/docker-basics/docker-101-banner.png)
...
![VM vs Docker Comparison](vm-vs-docker.png)
...
![VM vs Container Comparison](vm-vs-container.png)
...
![Container Build Steps](container-build-steps.png)
