...
![banner-image|640](thm-blaster-banner.png)
...
![Web App Landing Page|550](posts/images/thm-blaster/webapp-landing-page.png)
...
![Comment on Post|500](webapp-comment.png)
...
![Access Target with RDP|500](target-access-rdp.png)
...
![Executable Filename|500](executable-file.png)
...
![User Privilege Level|250](user-privilege.png)
...
![Flag File Content|420](flag-file.png)
...
![Setting Exploit Options|380](exploit-options.png)
...
![Executing Exploit on Target](posts/images/thm-blaster/running-exploit.png)
...
![Generate PS Payload|580](generate-payload.png)

![Sending Payload to Target](sending-payload.png)
...
![Setup Persistence on Target](setup-persistence.png)
