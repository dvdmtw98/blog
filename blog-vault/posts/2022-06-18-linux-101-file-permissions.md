...
![banner-image|640](linux-permissions-banner.png)
...
![File Owner Details|550](file-owner-details.png)
...
![File Permissions 2|540](file-permissions-2.png)
...
![File Permissions 3|450](file-permissions-3.png)
...
![Changing File Permission|480](change-file-permission.png)
...
![Changing File Permission 2|460](change-file-permission-2.png)

![Changing File Permission 3|480](change-file-permission-3.png)

As we can see with this approach we can quite quickly and elegantly set the permissions for the file.

![Change File Permission 4|480](change-file-permission-4.png)
