...
![banner-image|640](dns-explained-banner.png)
...
![DNS Internal Working](dns-internal-working.png)
...
![Root Name server lookup|450](dns-root-server-lookup.png)
...
![TLD Name server lookup|450](dns-tld-server-lookup.png)
...
![Authoritative Name server lookup|450](dns-authoritative-server-lookup.png)
...
![Google IP Address|450](dns-lookup-result.png)
...
- [DNS \| DNS Zones \| DNS Records - Digital Archive](https://notes.davidvarghese.com/computer-networks/network-infrastructure/dns-server/domain-name-system-dns)
