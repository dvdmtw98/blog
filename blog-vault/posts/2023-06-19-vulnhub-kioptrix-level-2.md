...
![banner-image|640](kioptrix-level-2-banner.png)
...
![Kioptrix Login|550](kioptrix-login.png)
...
![Netdiscover|550](posts/images/vulnhub-kioptrix-lvl2/netdiscover.png)
...
![Rust scan Result|540](rustscan.png)
...
![Web Application](posts/images/vulnhub-kioptrix-lvl2/webapp.png)
...
![Feroxbuster](posts/images/vulnhub-kioptrix-lvl2/feroxbuster.png)
...
![Request Parameters](webapp-2.png)
...
![Sqlmap 1](sqlmap-1.png)

![Sqlmap|560](sqlmap-2.png)
...
![Web Application|300](posts/images/vulnhub-kioptrix-lvl2/webapp-3.png)

![Web Application|560](posts/images/vulnhub-kioptrix-lvl2/webapp-4.png)

On entering `127.0.0.1` as input a new page was loaded with the result of the `ping` command.

![Web Application|500](posts/images/vulnhub-kioptrix-lvl2/webapp-5.png)
...
![Web Application](posts/images/vulnhub-kioptrix-lvl2/webapp-6.png)
...
![Web Application|560](webapp-7.png)

![Netcat|580](netcat.png)
...
![Exploit Search|480](exploit.png)
...
Next Level: [VulnHub - Kioptrix: Level 3 (1.2) (#3)](https://blog.davidvarghese.com/posts/vulnhub-kioptrix-level-3/)
