...
![banner-image|640](thm-blue-banner.png)
...
![Nmap Scan Results](posts/images/thm-blue/nmap-scan-results.png)
...
![Nmap Scan Results|550](nmap-scan-results-2.png)
...
![Metasploit SMB Modules](metasploit-smb-modules.png)
...
![Metasploit Exploit Options](metasploit-exploit-options.png)

Looking at the output we can see that the RHOSTS field is empty, we need to enter the value for that field

![Setting RHOSTS value|460](set-exploit-rhosts-value.png)

![Metasploit Exploit Options 2](metasploit-exploit-options-2.png)
...
![Executing SMB Exploit on Target](executing-exploit.png)
...
![Remote Access to Target System Gained](remote-access-gained.png)
...
![Meterpreter Options](posts/images/thm-blue/meterpreter-options.png)

2. **Select this (use MODULE_PATH). Show options, what option are we required to change?**

Looking at the options we can see there are two options that we need to set the LHOST and SESSION

![Setting Meterpreter Options](meterpreter-options-2.png)
...
![Executing Meterpreter on Target](executing-exploit.png)
...
![Meterpreter Session Established](session-established.png)
...
![Collecting Target System Information|540](posts/images/thm-blue/target-osint.png)

7. **List all of the processes running via the 'ps' command. Just because we are system doesn't mean our process is. Find a process towards the bottom of this list that is running at NT AUTHORITY\SYSTEM and write down the process id (far left column).**

> No answer required

![Target System running Processes|500](posts/images/thm-blue/target-osint-3.png)
...
![Migrating Meterpreter|280](migrating-meterpreter.png)

## Task 4: Cracking

1. **Within our elevated meterpreter shell, run the command 'hashdump'. This will dump all of the passwords on the machine as long as we have the correct privileges to do so. What is the name of the non-default user?**

![Dumping System Hashes](dumping-system-hashes.png)
...
![Collecting Target Information|540](posts/images/thm-blue/target-osint-3.png)
...
![Finding Flag on System|350](posts/images/thm-blue/target-osint-4.png)

![Finding Flag on System 2|540](posts/images/thm-blue/target-osint-5.png)
...
![Finding Flag on System 3|450](posts/images/thm-blue/target-osint-6.png)
