...
![banner-image|640](thm-simple-ctf-banner.png)
...
![RustScan Results|520](posts/images/thm-simple-ctf/rustscan-results.png)
...
![Nmap Results](posts/images/thm-simple-ctf/nmap-results.png)
...
![Connect with FTP Server|280](ftp-connect.png)
...
![Accessing Web Server](web-server-connect.png)
...
![Robots File in Web App|450](posts/images/thm-simple-ctf/webapp-robots-file.png)
...
![Accessing Directory on Web App|500](webapp-directory-access.png)
...
![Gobuster Results](posts/images/thm-simple-ctf/gobuster-results.png)
...
![WebApp Landing Page](posts/images/thm-simple-ctf/webapp-landing-page.png)
...
![WebApp CMS Version](webapp-version.png)

![Searching for Exploit](posts/images/thm-simple-ctf/finding-exploit.png)
...
![Exploit CVE Details](exploit-details.png)

![Exploit Version|500](exploit-version.png)
...
![Python Script Converter](python-script-converter.png)

![Running Script Converter](running-script-converter.png)

After the conversion now when I run the code I get some output telling me how to use the script.

![Running Exploit Script](posts/images/thm-simple-ctf/running-exploit.png)
...
![Exploit Script Errors|450](exploit-script-error.png)

![Fixing Exploit Script Error](exploit-script-error-fix.png)
...
![Running Exploit Script|420](running-exploit-script.png)
...
![Changing Exploit Parameters|220](exploit-parameters.png)
...
![Gobuster Results](gobuster-results-2.png)
...
![WebApp Login Form](webapp-login-form.png)

![WebApp Dashboard](webapp-dashboard.png)
...
![SSH Login|460](posts/images/thm-simple-ctf/ssh-login.png)
...
![Viewing Flag File 1|300](posts/images/thm-simple-ctf/flag-file-1.png)
...
![Sudoers File Content|460](posts/images/thm-simple-ctf/sudoers-file-content.png)
...
![Binary Exploit Usage Instruction](binary-exploit-instruction.png)
...
![Flag File Content|340](posts/images/thm-simple-ctf/flag-file-2.png)
