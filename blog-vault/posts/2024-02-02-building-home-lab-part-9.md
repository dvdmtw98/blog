...
![banner-image|640](building-home-lab-part-9-banner.png)
...
![vbox-46|450](vbox-46.png)

The pfSense VM will now have an Adapter 6.

![vbox-47|500](vbox-47.png)
...
![pfsense-100|640](pfsense-100.png)
...
![pfsense-101|600](pfsense-101.png)
...
![pfsense-104|600](pfsense-104.png)
...
![pfsense-107|600](pfsense-107.png)
...
![pfsense-108|580](pfsense-108.png)
...
![pfsense-112|580](pfsense-112.png)
...
![pfsense-113|580](pfsense-113.png)
...
![pfsense-114|580](pfsense-114.png)
...
![pfsense-115|580](pfsense-115.png)

In the popup click on **`Apply Changes`** to persist the new rule.

![pfsense-116|580](pfsense-116.png)

The final result will be as follows:

![pfsense-117|580](pfsense-117.png)
...
![tsurugi-21|540](tsurugi-21.png)

Select <u>Keyboard</u> and click on **`Continue`**.

![tsurugi-22|540](tsurugi-22.png)
...
![tsurugi-23|540](tsurugi-23.png)

Click on **`Install Now`**.

![tsurugi-24|540](tsurugi-24.png)

Click on **`Continue`**.

![tsurugi-25|540](tsurugi-25.png)

Select your <u>location/timezone</u> using the map and click on **`Continue`**.

![tsurugi-26|540](tsurugi-26.png)

Provide a username, computer name and password then click on **`Continue`**.

![tsurugi-27|540](tsurugi-27.png)

![tsurugi-28|540](tsurugi-28.png)

After the installation is complete click on "<u>Restart Now</u>".

![tsurugi-30|400](tsurugi-30.png)
...
![tsurugi-31|540](tsurugi-31.png)

Login using the password that was configured.

![tsurugi-32|540](tsurugi-32.png)
...
![tsurugi-41|540](tsurugi-41.png)

Click on **`Take`** to create a Snapshot.

![tsurugi-42|540](tsurugi-42.png)
...
[Part 10 - Splunk Setup & Configuration](https://blog.davidvarghese.com/posts/building-home-lab-part-10/)
